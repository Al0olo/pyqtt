...
If you want to contribute to `pymqtt` or work on the code it's recommended
...
```bash
git clone git@github.com:[YOUR_GITHUB_USERNAME]/pyqtt.git
cd pyqtt
python3 -m venv .
source bin/activate
...
```bash
git remote add upstream git@github.com:al0olo/pyqtt.git
