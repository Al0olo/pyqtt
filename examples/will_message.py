...
async def main(broker_host, broker_port, token):
    ...
    will_message = pyqtt.Message('TEST/WILL/42', "I'm dead finally", will_delay_interval=10)
    will_client = pyqtt.Client("clientgonnadie", will_message=will_message)
    ...
    another_client = pyqtt.Client("clientgonnalisten")
